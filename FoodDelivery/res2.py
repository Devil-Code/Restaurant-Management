...
def Ref():
    ...
    CostofIdly =CoIdly * 100
    CostofDrinks=CoD * 200
...
lblIdly= Label(f1, font=('arial', 16, 'bold'),text="Chocolate Ice-cream",bd=16,anchor="w")
...
lblDosa= Label(f1, font=('arial', 16, 'bold'),text="Jalebi Rabri",bd=16,anchor="w")
...
lblKesari= Label(f1, font=('arial', 16, 'bold'),text="Gajar Halwa",bd=16,anchor="w")
...
lblPulav= Label(f1, font=('arial', 16, 'bold'),text="Brownie",bd=16,anchor="w")
...
lblKarabath= Label(f1, font=('arial', 16, 'bold'),text="Calcutta Paan",bd=16,anchor="w")
...
lblDrinks= Label(f1, font=('arial', 16, 'bold'),text="Water",bd=16,anchor="w")
