...
#    for i in range(len(item)):
    cursor.execute('INSERT INTO DATA(ITEM,QUAN) VALUES ("%s","%s")' % (item,quan))
    db_connection.close() 
...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="VADAVALI TIGERS CLUB",fg="Steel Blue",bd=10,anchor='w')
...
def Ref():
    ...
    if (Kesari.get()==""):
        ...
        item.append("Kesari Rice")
        quan.append(CoKesari)
    ...
    if (Karabath.get()==""):
        ...
        item.append("Karabath")
        quan.append(CoKarabath)
    ...
    CostofDrinks=CoD * 20
    CostofDosa = CoDosa* 200
    CostofKesari = CoKesari * 250
    CostPulav = CoPulav* 300
    CostKarabath=CoKarabath * 200
...
lblIdly= Label(f1, font=('arial', 16, 'bold'),text="SHAWARMA",bd=16,anchor="w")
...
lblDosa= Label(f1, font=('arial', 16, 'bold'),text="Butter Chicken",bd=16,anchor="w")
...
lblKesari= Label(f1, font=('arial', 16, 'bold'),text="Chicken Biryani",bd=16,anchor="w")
...
lblPulav= Label(f1, font=('arial', 16, 'bold'),text="Tandoori Chicken",bd=16,anchor="w")
...
lblKarabath= Label(f1, font=('arial', 16, 'bold'),text="Mutton Rogan Josh",bd=16,anchor="w")
...
btnExit=Button(f1,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Back",bg="powder blue",command=qExit).grid(row=7,column=3)
